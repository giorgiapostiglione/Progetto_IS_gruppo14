...
public class CalculatorController {
    ...
    /**
     * Costruttore della classe CalculatorController. Riceve un modello
     * (CalculatorModel) e una vista (CalculatorView) come argomenti.
     * Inizializza i membri model e view con i rispettivi argomenti e chiama i
     * metodi per inizializzare i pulsanti e le associazioni.
     *
...
// SOLO PER I TEST DEL CONTROLLER
    ...
    /**
     * Inizializza le azioni degli eventi per i pulsanti nella tastiera numerica
     * e nella tastiera delle lettere. Associa le azioni degli eventi ai metodi
     * appropriati del controller.
     */
    ...
    /**
     * Gestisce l'azione quando un pulsante nella tastiera numerica o delle
     * lettere viene premuto. Aggiunge il testo del pulsante al campo di
    ...
    /**
     * Gestisce l'azione quando un pulsante di controllo (C, MC, MO, MS, MD, MU,
     * EXE) viene premuto. Modifica lo stato della calcolatrice in base al
     * pulsante premuto. Aggiorna il campo di visualizzazione, disabilita alcuni
     * pulsanti in caso di errore e aggiorna la memoria.
     *
     * @param e L'evento di azione generato dal pulsante premuto.
     */
    ...
    /**
     * Verifica e processa l'input inserito nella calcolatrice. Se l'input
     * corrisponde a un numero complesso, lo inserisce nello stack della
     * calcolatrice.
     *
     * @param input L'input inserito nella calcolatrice.
     * @throws RuntimeException Se si verifica un'eccezione durante
     * l'elaborazione.
     */
    ...
    /**
     * Verifica e processa l'input inserito nella calcolatrice. Se l'input
     * corrisponde a un'operazione matematica esegue l'operazione
     * corrispondente.
     *
     * @param input L'input inserito nella calcolatrice.
     * @throws RuntimeException Se si verifica un'eccezione durante
    ...
    /**
     * Verifica e processa l'input inserito nella calcolatrice. Se l'input
     * corrisponde a una manipolazione delle variabili, esegue l'operazione
     * corrispondente.
     *
     * @param input L'input inserito nella calcolatrice.
     * @throws RuntimeException Se si verifica un'eccezione durante
    ...
    /**
     * Inizializza le proprietà di disabilitazione per alcuni pulsanti della
     * tastiera numerica in base al contenuto del campo di visualizzazione della
     * calcolatrice. Alcuni pulsanti sono disabilitati quando il campo di
     * visualizzazione è vuoto.
     */
