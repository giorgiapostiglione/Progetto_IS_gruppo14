...
public class CalculatorModel implements OperazioniAritmetiche, OperazioniConVariabii, OperazioniStrutturaDati {
    ...
    /**
     * Costruttore della classe CalculatorModel. Inizializza uno stack finito
     * (sf) e una mappa per le variabili (variabili).
     */
    ...
    /**
     * Restituisce una rappresentazione in formato stringa delle variabili e dei
     * loro valori complessi. La rappresentazione è nel formato
     * "variabile1=valore1, variabile2=valore2, ...".
     *
     * @return Una stringa che rappresenta le variabili e i loro valori
     * complessi.
     */
     ...
     * @throws StackFullException Se lo stack è pieno e non può accettare nuovi
     * elementi.
     */
    ...
    /**
     * Esegue un'operazione di somma su due numeri complessi nello stack. Lancia
     * un'eccezione NotEnoughElementException se non ci sono abbastanza elementi
     * nello stack.
     *
     * @throws NotEnoughElementException Se non ci sono abbastanza elementi
     * nello stack per eseguire l'operazione.
     */
    @Override
     ...
     * Lancia un'eccezione NotEnoughElementException se non ci sono abbastanza
    ...
    /**
     * Esegue un'operazione di moltiplicazione su due numeri complessi nello
     * stack. Lancia un'eccezione NotEnoughElementException se non ci sono
     * abbastanza elementi nello stack.
     *
     * @throws NotEnoughElementException Se non ci sono abbastanza elementi
     * nello stack per eseguire l'operazione.
     */
     ...
     * Lancia un'eccezione NotEnoughElementException se non ci sono abbastanza
     * elementi nello stack. Lancia un'eccezione DivisionByZeroException se il
     * denominatore è zero.
     *
     * @throws NotEnoughElementException Se non ci sono abbastanza elementi
     * nello stack per eseguire l'operazione.
    ...
    /**
     * Esegue un'operazione di calcolo della radice quadrata su un numero
     * complesso nello stack. Lancia un'eccezione StackUnderflowException se lo
     * stack è vuoto.
     *
    ...
    /**
     * Esegue un'operazione di cambio di segno su un numero complesso nello
     * stack. Lancia un'eccezione StackUnderflowException se lo stack è vuoto.
     *
     * @throws StackUnderflowException Se lo stack è vuoto.
     */
    @Override
    ...
    /**
     * Scambia gli ultimi due elementi nello stack. Lancia un'eccezione
     * NotEnoughElementException se non ci sono abbastanza elementi nello stack.
     *
     * @throws NotEnoughElementException Se non ci sono abbastanza elementi
     * nello stack per eseguire l'operazione.
     */
    ...
    /**
     * Rimuove l'ultimo elemento presente nello stack. Lancia un'eccezione
     * StackUnderflowException se lo stack è vuoto.
     *
     * @throws StackUnderflowException Se lo stack è vuoto.
     */
    @Override
    ...
    /**
     * Duplica l'ultimo elemento presente nello stack. Lancia un'eccezione
     * StackUnderflowException se lo stack è vuoto. Lancia un'eccezione
     * StackFullException se lo stack è pieno.
     *
     * @throws StackUnderflowException Se lo stack è vuoto.
     * @throws StackFullException Se lo stack è pieno.
     */
    ...
    /**
     * Sovrapponi l'elemento penultimo con l'ultimo elemento presente nello
     * stack. Lancia un'eccezione NotEnoughElementException se ci sono meno di
     * due elementi nello stack. Lancia un'eccezione StackFullException se lo
     * stack è pieno.
     *
     * @throws NotEnoughElementException Se ci sono meno di due elementi nello
     * stack.
     * @throws StackFullException Se lo stack è pieno.
     */
    @Override
    ...
    /**
     * Esegue un'operazione di somma tra il valore della variabile specificata e
     * il valore presente nello stack, quindi aggiorna il valore della variabile
     * con il risultato. Lancia un'eccezione InvalidVariableException se la
     * variabile specificata non esiste. Lancia un'eccezione
     * StackUnderflowException se lo stack è vuoto.
     *
    ...
    /**
     * Esegue un'operazione di differenza tra il valore della variabile
     * specificata e il valore presente nello stack, quindi aggiorna il valore
     * della variabile con il risultato. Lancia un'eccezione
     * InvalidVariableException se la variabile specificata non esiste. Lancia
     * un'eccezione StackUnderflowException se lo stack è vuoto.
     *
     * @param c Il carattere rappresentante la variabile.
     * @throws InvalidVariableException Se la variabile specificata non esiste.
     * @throws StackUnderflowException Se lo stack è vuoto.
     ...
     * Lancia un'eccezione InvalidVariableException se la variabile specificata
     * non esiste. Lancia un'eccezione StackFullException se lo stack è pieno.
     *
     * @param c Il carattere rappresentante la variabile.
     * @throws InvalidVariableException Se la variabile specificata non esiste.
     * @throws StackFullException Se lo stack è pieno.
    ...
    /**
     * Assegna il valore presente nello stack alla variabile specificata. Se la
     * variabile esiste già, ne aggiorna il valore. Se la variabile non esiste,
     * la crea e le assegna il valore presente nello stack. Lancia un'eccezione
     * StackUnderflowException se lo stack è vuoto.
     *
     * @param c Il carattere rappresentante la variabile.
     * @throws StackUnderflowException Se lo stack è vuoto.
