...
public class StackFinitoTest {
    ...
    /**
     * Test del metodo getSize della classe StackFinito. Verifica che getSize
     * restituisca 0 essendo lo stack vuoto. Classe d'equivalenza testata: Stack
     * vuoto.
     */
    @Test
    ...
    /**
     * Test del metodo getMaxSize della classe StackFinito. Verifica che
     * getMaxSize prelevi correttamente l'attributo privato maxSize. Classe
     * d'equivalenza testata: Nessuna inserzione o rimozione di elementi.
     */
    @Test
    ...
    /**
     * Test del metodo push della classe StackFinito. Verifica che l'elemento
     * presente in cima allo stack sia uguale a quello inserito. Classe
     * d'equivalenza testata: Parte reale e immaginaria con valori arbitrari
     * (-55.603, 81).
     */
    @Test
    ...
    /**
     * Test del metodo push della classe StackFinito. Verifica che gli ultimi
     * elementi presenti in cima allo stack siano uguali a quelli inseriti.
     * Classe d'equivalenza testata: Parte reale e immaginaria con valori
     * arbitrari per quattro elementi diversi.
     */
    @Test
    ...
    /**
     * Test del metodo push della classe StackFinito. Verifica che la condizione
     * di stack pieno venga riconosciuta. Classe d'equivalenza testata:
     * Inserimento di 50 elementi casuali.
     */
    @Test
    ...
    /**
     * Test del metodo push della classe StackFinito. Verifica che la dimensione
     * dello stack aumenti dopo la push. Classe d'equivalenza testata:
     * Inserimento di un elemento con parte reale e immaginaria specifici.
     */
    @Test
    ...
    /**
     * Test del metodo viewElement della classe StackFinito. Verifica che
     * viewElement restituisca correttamente un elemento presente nello stack
     * con un solo elemento. Classe d'equivalenza testata: Stack con un solo
     * elemento.
     */
    @Test
     ...
     * Test del metodo viewElement della classe StackFinito. Verifica che
     * viewElement restituisca correttamente un elemento presente nello stack
     * con più elementi. Classe d'equivalenza testata: Stack con più elementi.
     */
    @Test
    ...
    /**
     * Test del metodo pop della classe StackFinito. Verifica che l'elemento
     * inserito sia uguale a quello prelevato dalla pop in caso di stack vuoto.
    ...
    /**
     * Test del metodo pop della classe StackFinito. Verifica che l'elemento
     * inserito sia uguale a quello prelevato dalla pop in caso di stack con un
     * elemento. Classe d'equivalenza testata: Un elemento nello stack con parte
     * reale e immaginaria specifici.
     */
    @Test
    ...
    /**
     * Test del metodo pop della classe StackFinito. Verifica che l'elemento
     * inserito sia uguale a quello prelevato dalla pop in caso di stack con più
     * elementi. Classe d'equivalenza testata: Più elementi nello stack con
     * parti reali e immaginarie specifiche.
     */
    @Test
    ...
    /**
     * Test del metodo pop della classe StackFinito. Verifica che la dimensione
     * dello stack diminuisca dopo la pop. Classe d'equivalenza testata:
    ...
    /**
     * Test del metodo getSize della classe StackFinito. Verifica che getSize
     * restituisca la dimensione effettiva dello stack dopo una push. Classe
     * d'equivalenza testata: Inserimento di tre elementi nello stack.
     */
    @Test
    ...
    /**
     * Test del metodo getSize della classe StackFinito. Verifica che getSize
     * restituisca la dimensione effettiva dello stack dopo una push e una pop.
     * Classe d'equivalenza testata: Inserimento di tre elementi e rimozione di
     * uno.
     */
    @Test
    ...
    /**
     * Test del metodo stampaDodiceElementi della classe StackFinito. Verifica
     * che stampaDodiceElementi restituisca una stringa vuota per uno stack
     * vuoto. Classe d'equivalenza testata: Stack vuoto.
     */
    @Test
    ...
    /**
     * Test del metodo stampaDodiceElementi della classe StackFinito. Verifica
     * che stampaDodiceElementi restituisca una stringa con gli unici dodici
     * elementi presenti nello stack. Classe d'equivalenza testata: StackFinito.
     */
    @Test
    ...
    /**
     * Test del metodo stampaDodiceElementi della classe StackFinito. Verifica
     * che stampaDodiceElementi restituisca una stringa con i primi dodici
     * elementi presenti in cima allo stack. Classe d'equivalenza testata:
     * StackFinito.
     */
    @Test
